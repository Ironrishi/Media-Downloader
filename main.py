...
# Download video
def mp4(url, output_path_template=r'C:\Users\%(title)s.%(ext)s'):  # Replace with your desired output folder
...
# Download audio
def mp3(url, output_path_template=r'C:\Users\%(title)s.%(ext)s'): # Replace with your desired output folder
